...
function stop_green_feature()
    gg.setSpeed(1)
    gg.unrandomizer(0, 0, 0, 0)
    GREEN_ACTIVE = false
    gg.alert("🔄 تم الإيقاف")
end
...
function fishing_menu()
    local menu = {
        "🎣 كوبونات خضراء + زيادة طعام الاسماك",
        " إيقاف سرعه الصيد و الحظ❌",
    ...
    if choice == 2 then stop_green_feature() end
...
-- ================================
function m1_copy1() gg.copyText("https://t.me/mm_ipp232/10"); gg.alert("📋 تم نسخ الرابط  افتحه في متصفح او تلجرام 🤗") end

function m1_copy2() gg.copyText("https://t.me/mm_ipp232/14"); gg.alert("📋 تم نسخ الرابط  افتحه في متصفح او تلجرام 🤗") end

function m1_copy3() gg.copyText("https://t.me/mm_ipp232/19"); gg.alert("📋 تم نسخ الرابط  افتحه في متصفح او تلجرام 🤗") end

function m1_copy4() gg.copyText(""); gg.alert("📋 تم نسخ الرابط  افتحه في متصفح او تلجرام 🤗") end

function m1_copy5() gg.copyText(""); gg.alert("📋 تم نسخ الرابط  افتحه في متصفح او تلجرام 🤗") end


function m_s9()

    local c = gg.choice({
        "🌟نسخ رابط مزرعه تقبل الملفات 🌟",
        "🌟نسخ رابط مزرعه المعدله 🌟",
        "🌟نسخ رابط الكناري لتشغيل المعدله 🌟",
        "🌟",
        "🌟",
        "⬅️ رجوع"  
    ...
    if c == 1 then m1_copy1()
    elseif c == 2 then m1_copy2()
    elseif c == 3 then m1_copy3()
    elseif c == 4 then m1_copy4()
    elseif c == 5 then m1_copy5()
    elseif c == 6 then 
...
function m1_f1()
 local folder = "/storage/emulated/0/Download/"
   local fileName = "syncErrorRumEvent.lua"
    local path = folder .. "/" .. fileName

    local url = "https://gitlab.com/mmipp232/mmipp232/-/raw/main/syncErrorRumEvent.lua"
    ...
    gg.alert("تم التحميل بنجاح ✅\n روح علي الملفات في الداونلود mt 🌟")
end
--==========jpg====
function m1_f2()
    local folder = "/storage/emulated/0/Download/"
   local fileName = "util.lua"
    local path = folder .. "/" .. fileName

    local url = "https://gitlab.com/mmipp232/mmipp232/-/raw/main/util.lua"
...
function m1_f3()
local folder = "/storage/emulated/0/Download/"
   local fileName = "المهام اليوميه.zip"
    local path = folder .. "/" .. fileName

    local url = "https://gitlab.com/mmipp232/mmipp232/-/raw/main/%D9%85%D9%87%D8%A7%D9%85_%D8%A7%D9%84%D9%8A%D9%88%D9%85%D9%8A%D9%87_.zip"
...
function m1_f4()
 local folder = "/storage/emulated/0/Download/"
   local fileName = "تكرار اوامر.apk"
    local path = folder .. "/" .. fileName

    local url = "https://gitlab.com/mmipp232/mmipp232/-/raw/main/%D8%AA%D9%83%D8%B1%D8%A7%D8%B1_%D8%A7%D9%88%D8%A7%D9%85%D8%B1.apk?ref_type=heads"
...
function m1_f5()
 local folder = "/storage/emulated/0/Download/"
   local fileName = "تسريع المعدله مع حذف الشات.zip"
    local path = folder .. "/" .. fileName

    local url = "https://gitlab.com/mmipp232/mmipp232/-/raw/main/%D8%AA%D8%B3%D8%B1%D9%8A%D8%B9_%D8%A7%D9%84%D9%85%D8%B9%D8%AF%D9%84%D9%87_%D9%85%D8%B9_%D8%AD%D8%B0%D9%81_%D8%A7%D9%84%D8%B4%D8%A7%D8%AA.zip"
...
function footome()
    local c = gg.choice({
       "🌟نسخ روابط وبرامج المزارع 🐄",
       "🌟تحميل ملف الخطأ 🌟",
       "🌟تحميل ملف الحظ 🌟",
       "🌟تحميل ملف المهام اليومية +اسكربت 🌟",
        "🌟تحميل مرنامج تكرار اوامر 🌟",
        "🌟تحميل ملف تسريع المعدله مع خذف الشات 🌟",
        "⬅️ رجوع" 
    }, nil, "♥️👑 مــحــمــد رأفــت 👑♥️")
